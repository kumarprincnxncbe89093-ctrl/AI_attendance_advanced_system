...
def voice_attendance_dialog(selected_subject_id):
    st.markdown(
        ...
        <div class="dialog-panel">
            <div class="dialog-kicker">Voice recognition</div>
            <h3>Voice Attendance</h3>
            <p>Record students saying they are present, then analyze the audio against saved voice profiles.</p>
        </div>
        """,
